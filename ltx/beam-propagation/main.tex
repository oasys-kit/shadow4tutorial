...
\captionof{figure}{Evolution of the phase space. Top:  in X (horizontal), bottom: in Z (vertical).}
\label{fig:bp-fig1}
\end{center}
...
\captionof{figure}{Evolution of the phase space. Effect of a slit in the first screen. Top:  in X (horizontal), bottom: in Z (vertical).}
\label{fig:bp-fig2}
\end{center}
