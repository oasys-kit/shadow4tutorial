...
\\[10pt]
F_{30} &=& \frac{1}{2}\left(\frac{\sin\alpha}{r}\left(\frac{\cos^2\alpha}{r} - \frac{\cos\alpha}{R}\right) + (\beta r')\right) - \frac{m\lambda\, b_3}{d_0}
\end{eqnarray}
...
and $\be$ is the diffraction angle. Positivs angles are counterclockwise (CCW). In SHADOW notation
...
\caption{
  Effect of slope errors on the toroidal mirror in the vertical PGM.
  The image on the slit plane with with realistic r.m.s. slope errors is  $\sim 18.4\,\mu$m (ideal, no slope errors: $\sim 5.8\,\mu$m).
...
The \textbf{Follath PGM} (R.\ Follath and F.\ Senf, NIM A\,390, 388, 1997) uses the toroidal mirror, such as the 
